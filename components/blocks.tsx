      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">En tant qu'Ingénieur Développement Full Stack, j'ai une expertise en Java, JavaScript, Python, et C#, et je maîtrise des frameworks comme Vue.js, ReactJS, et Spring Boot. Mon expérience inclut la conception de solutions SaaS en 3D, l'intégration continue (CI/CD), et la gestion de bases de données comme PostgreSQL et MongoDB</p>
          </div>
